#ifndef MULTI_ALT_EXP_VEC_BC_CONST_MODEL_H
#define MULTI_ALT_EXP_VEC_BC_CONST_MODEL_H
...
class multi_alt_exp_vec_BC_const_model : public abstract_model
{
  public:

    multi_alt_exp_vec_BC_const_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, string _T_str, string _C_str, int n_exp, int m_exp, int n_vec);
    ~multi_alt_exp_vec_BC_const_model();
...
// derived functions
  ...
  private:
    ...
    multi_alt_exp_vec_BC_model* model;
