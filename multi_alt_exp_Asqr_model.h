#ifndef MULTI_ALT_EXP_ASQR_MODEL_H
#define MULTI_ALT_EXP_ASQR_MODEL_H
...
class multi_alt_exp_Asqr_model : public abstract_model
{
  public:

    multi_alt_exp_Asqr_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, int n_exp, int m_exp);
    ~multi_alt_exp_Asqr_model();
...
// derived functions
  ...
  private:
    ...
    multi_exp_Asqr_model* standard_exp_model;
    multi_exp_Asqr_model* alternating_exp_model;
