#ifndef MULTI_ALT_EXP_ASQR_EXPE_VEC_BC_MODEL_H
#define MULTI_ALT_EXP_ASQR_EXPE_VEC_BC_MODEL_H
...
class multi_alt_exp_Asqr_expE_vec_BC_model : public abstract_model
{
  public:

    multi_alt_exp_Asqr_expE_vec_BC_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, string _T_str, int n_exp, int m_exp, int n_vec);
    ~multi_alt_exp_Asqr_expE_vec_BC_model();
