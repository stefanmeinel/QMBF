#ifndef THREEPT_MULTI_ALT_EXP_EXPE_MODEL_H
#define THREEPT_MULTI_ALT_EXP_EXPE_MODEL_H
...
class threept_multi_alt_exp_expE_model : public abstract_model
{
  public:

    threept_multi_alt_exp_expE_model(string _E_str, string _dE_str, string _F_str, string _dF_str, string _A_str, string _B_str, string _t_str, string _T_str, int n_exp_initial, int m_exp_initial, int n_exp_final, int m_exp_final);
...
// derived functions
  ...
  private:
    ...
    threept_multi_exp_expE_model* ee_model;
    threept_multi_exp_expE_model* oe_model;
    threept_multi_exp_expE_model* eo_model;
    threept_multi_exp_expE_model* oo_model;
