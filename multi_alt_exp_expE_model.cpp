...
multi_alt_exp_expE_model::multi_alt_exp_expE_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, int n_exp, int m_exp)
{
  E_str=_E_str;
  dE_str=_dE_str;
  A_str=_A_str;
  ...
  standard_exp_model=new multi_exp_expE_model(E_str, dE_str, A_str, B_str, t_str, nexp);
  alternating_exp_model=new multi_exp_expE_model(E_str+"o", dE_str+"o", A_str+"o", B_str+"o", t_str, mexp);
}


multi_alt_exp_expE_model::~multi_alt_exp_expE_model()
{
...
int multi_alt_exp_expE_model::get_n_functions()
{
  return 1;
}


int multi_alt_exp_expE_model::get_n_variables()
{
  return 1;
}


int multi_alt_exp_expE_model::get_n_parameters()
{
  return 2*(nexp+mexp);
}

int multi_alt_exp_expE_model::get_n_constants()
{
  return 0;
}


void multi_alt_exp_expE_model::set_parameters(const vector< double >& parameters)
{
...
void multi_alt_exp_expE_model::set_constants(const vector< double >& constants)
{
}


double multi_alt_exp_expE_model::alt(double x)
{
...
double multi_alt_exp_expE_model::eval_function(int function, const vector< double >& arguments)
{
...
double multi_alt_exp_expE_model::eval_derivative(int function, int parameter, const vector< double >& arguments)
{
...
int multi_alt_exp_expE_model::no_of_errors()
{
  return standard_exp_model->no_of_errors()+alternating_exp_model->no_of_errors();
}


string multi_alt_exp_expE_model::get_function_name(int function, string variable)
{
...
string multi_alt_exp_expE_model::get_function_name(int function)
{
  return get_function_name(function, t_str);
}


string multi_alt_exp_expE_model::get_parameter_name(int parameter)
{
...
string multi_alt_exp_expE_model::get_variable_name(int variable)
{
  if(variable!=0)
  {
    return "";
...
string multi_alt_exp_expE_model::get_constant_name(int constant)
{
  return "";
}
