#ifndef THREEPTMULTIALTEXPDIALOG_H
#define THREEPTMULTIALTEXPDIALOG_H

#include <QtWidgets>

class threept_multi_alt_exp_dialog : public QDialog
{
  Q_OBJECT

  public:
    threept_multi_alt_exp_dialog(int n_exp_initial, int max_n_exp_initial, int m_exp_initial, int max_m_exp_initial, int n_exp_final, int max_n_exp_final, int m_exp_final, int max_m_exp_final, QWidget* parent);
