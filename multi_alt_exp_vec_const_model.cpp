...
multi_alt_exp_vec_const_model::multi_alt_exp_vec_const_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, string _C_str, int n_exp, int m_exp, int n_vec)
{
  E_str=_E_str;
  dE_str=_dE_str;
  A_str=_A_str;
  ...
  C.resize(nvec);
  Co.resize(nvec);
  model=new multi_alt_exp_vec_model(E_str, dE_str, A_str, B_str, t_str, n_exp, m_exp, n_vec);
}


multi_alt_exp_vec_const_model::~multi_alt_exp_vec_const_model()
{
  delete model;
}


int multi_alt_exp_vec_const_model::get_n_functions()
{
  return model->get_n_functions();
}


int multi_alt_exp_vec_const_model::get_n_variables()
{
  return model->get_n_variables();
}


int multi_alt_exp_vec_const_model::get_n_parameters()
{
  return model->get_n_parameters()+2*nvec;
}

int multi_alt_exp_vec_const_model::get_n_constants()
{
  return model->get_n_constants();
}


void multi_alt_exp_vec_const_model::set_parameters(const vector< double >& parameters)
{
...
void multi_alt_exp_vec_const_model::set_constants(const vector< double >& constants)
{
  model->set_constants(constants);
}


double multi_alt_exp_vec_const_model::eval_function(int function, const vector< double >& arguments)
{
  return model->eval_function(function, arguments)+C[function]+alt(arguments[0]+1)*Co[function];
}


double multi_alt_exp_vec_const_model::eval_derivative(int function, int parameter, const vector< double >& arguments)
{
...
int multi_alt_exp_vec_const_model::no_of_errors()
{
  return model->no_of_errors();
}


string multi_alt_exp_vec_const_model::get_function_name(int function)
{
...
string multi_alt_exp_vec_const_model::get_parameter_name(int parameter)
{
  if(parameter < model->get_n_parameters())
  {
...
string multi_alt_exp_vec_const_model::get_variable_name(int variable)
{
  return model->get_variable_name(variable);
}

string multi_alt_exp_vec_const_model::get_constant_name(int constant)
{
  return model->get_constant_name(constant);
}

double multi_alt_exp_vec_const_model::alt(double x)
{
