#ifndef MULTI_ALT_EXP_EXPE_NONSYM_MAT_MODEL_H
#define MULTI_ALT_EXP_EXPE_NONSYM_MAT_MODEL_H
...
class multi_alt_exp_expE_nonsym_mat_model : public abstract_model
{
  public:

    multi_alt_exp_expE_nonsym_mat_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, int n_exp, int m_exp, int dim_1, int dim_2);
    ~multi_alt_exp_expE_nonsym_mat_model();
...
// derived functions
  ...
  private:
    ...
    multi_exp_expE_nonsym_mat_model* standard_exp_mat_model;
    multi_exp_expE_nonsym_mat_model* alternating_exp_mat_model;
