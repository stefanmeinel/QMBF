...
multi_exp_mat_II_model::multi_exp_mat_II_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, int n_exp, int dim_1, int dim_2)
{
  E_str=_E_str;
  dE_str=_dE_str;
  A_str=_A_str;
...
int multi_exp_mat_II_model::get_n_functions()
{
  return dim1*dim2;
}


int multi_exp_mat_II_model::get_n_variables()
{
  return 1;
}


int multi_exp_mat_II_model::get_n_parameters()
{
  return params.size();
}

int multi_exp_mat_II_model::get_n_constants()
{
  return 0;
}


void multi_exp_mat_II_model::set_parameters(const vector< double >& parameters)
{
  params=parameters;
}


void multi_exp_mat_II_model::set_constants(const vector< double >& constants)
{
}


double multi_exp_mat_II_model::eval_function(int function, const vector< double >& arguments)
{
...
double multi_exp_mat_II_model::eval_derivative(int function, int parameter, const vector< double >& arguments)
{
  int v1=function/dim2;
  int v2=function%dim2;
...
int multi_exp_mat_II_model::no_of_errors()
{
  return 0;
}


string multi_exp_mat_II_model::get_function_name(int function, string variable)
{
  int v1=function/dim2;
  int v2=function%dim2;
...
string multi_exp_mat_II_model::get_function_name(int function)
{
  return get_function_name(function, t_str);
}


string multi_exp_mat_II_model::get_parameter_name(int parameter)
{
...
string multi_exp_mat_II_model::get_variable_name(int variable)
{
  if(variable!=0)
  {
    return "";
...
string multi_exp_mat_II_model::get_constant_name(int constant)
{
  return "";
}
