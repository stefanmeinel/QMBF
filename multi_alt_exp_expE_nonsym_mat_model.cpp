...
multi_alt_exp_expE_nonsym_mat_model::multi_alt_exp_expE_nonsym_mat_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, int n_exp, int m_exp, int dim_1, int dim_2)
{
  E_str=_E_str;
  dE_str=_dE_str;
  A_str=_A_str;
  ...
  dim2=dim_2;
  standard_exp_mat_model=new multi_exp_expE_nonsym_mat_model(E_str, dE_str, A_str, B_str, t_str, nexp, dim1, dim2);
  alternating_exp_mat_model=new multi_exp_expE_nonsym_mat_model(E_str+"o", dE_str+"o", A_str+"o", B_str+"o", t_str, mexp, dim1, dim2);
...
multi_alt_exp_expE_nonsym_mat_model::~multi_alt_exp_expE_nonsym_mat_model()
{
...
int multi_alt_exp_expE_nonsym_mat_model::get_n_functions()
{
  return standard_exp_mat_model->get_n_functions();
}


int multi_alt_exp_expE_nonsym_mat_model::get_n_variables()
{
  return standard_exp_mat_model->get_n_variables();
}


int multi_alt_exp_expE_nonsym_mat_model::get_n_parameters()
{
  return standard_exp_mat_model->get_n_parameters()+alternating_exp_mat_model->get_n_parameters();
}

int multi_alt_exp_expE_nonsym_mat_model::get_n_constants()
{
  return 0;
}


void multi_alt_exp_expE_nonsym_mat_model::set_parameters(const vector< double >& parameters)
{
...
void multi_alt_exp_expE_nonsym_mat_model::set_constants(const vector< double >& constants)
{
}


double multi_alt_exp_expE_nonsym_mat_model::alt(double x)
{
...
double multi_alt_exp_expE_nonsym_mat_model::eval_function(int function, const vector< double >& arguments)
{
...
double multi_alt_exp_expE_nonsym_mat_model::eval_derivative(int function, int parameter, const vector< double >& arguments)
{
...
int multi_alt_exp_expE_nonsym_mat_model::no_of_errors()
{
...
string multi_alt_exp_expE_nonsym_mat_model::get_function_name(int function, string variable)
{
...
string multi_alt_exp_expE_nonsym_mat_model::get_function_name(int function)
{
  return get_function_name(function, t_str);
}


string multi_alt_exp_expE_nonsym_mat_model::get_parameter_name(int parameter)
{
  if( (parameter >= 0) && (parameter < nexp) )
  {
...
string multi_alt_exp_expE_nonsym_mat_model::get_variable_name(int variable)
{
  if(variable!=0)
  {
    return "";
...
string multi_alt_exp_expE_nonsym_mat_model::get_constant_name(int constant)
{
  return "";
}
