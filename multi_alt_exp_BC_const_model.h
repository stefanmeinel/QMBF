#ifndef MULTI_ALT_EXP_BC_CONST_MODEL_H
#define MULTI_ALT_EXP_BC_CONST_MODEL_H
...
class multi_alt_exp_BC_const_model : public abstract_model
{
  public:

    multi_alt_exp_BC_const_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, string _T_str, string _C_str, int n_exp, int m_exp);
    ~multi_alt_exp_BC_const_model();
