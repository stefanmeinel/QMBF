#ifndef MULTI_EXP_ASQR_EXPE_CONST_MODEL_H
#define MULTI_EXP_ASQR_EXPE_CONST_MODEL_H
...
class multi_exp_Asqr_expE_const_model : public abstract_model
{
  public:

    multi_exp_Asqr_expE_const_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, string _C_str, int n_exp);
    ~multi_exp_Asqr_expE_const_model();
...
// derived functions
  ...
  private:
    ...
    multi_exp_Asqr_expE_model* model;
